...
local plug_map = {
	-- Plugin: bufferline
	["n|<C-Tab>"] = map_cr("BufferLineCycleNext"):with_noremap():with_silent():with_desc("buffer: Switch to next"),
	["n|<C-S-Tab>"] = map_cr("BufferLineCyclePrev"):with_noremap():with_silent():with_desc("buffer: Switch to prev"),
	["n|<A-Tab>"] = map_cr("BufferLineMoveNext"):with_noremap():with_silent():with_desc("buffer: Move current to next"),
	["n|<A-S-Tab>"] = map_cr("BufferLineMovePrev")
		:with_noremap()
		:with_silent()
